// src/pages/Form.jsx (estructura reemplazada pero mismas funciones)
import React, { useEffect, useState } from "react";
import "./styles/FeeBenchmarkingForm.css";
    ...
    useEffect(() => {
        async function loadTags() {
            try {
                ...
                console.error("Error cargando tags del formulario", err);
            }
        }
        loadTags();
    }, []);
